...
echo -e "Upgrading pip to the latest version..."
...
echo -e "Removing any existing 'public' directory..."
rm -rf public
# Inicializa reflex para el seguimiento de cambios
echo -e "Initializing reflex for tracking changes..."
reflex init
# Exporta el frontend solo utilizando reflex con la API_URL especificada
echo -e "Exporting frontend only using reflex with the specified API_URL..."
...
echo -e "Unzipping 'frontend.zip' file into the 'public' directory..."
unzip frontend.zip -d public
# Elimina el archivo 'frontend.zip'
echo -e "Removing 'frontend.zip' file..."
rm -f frontend.zip
# Desactiva el entorno virtual
echo -e "Deactivating the virtual environment..."
deactivate
